...
import { Search, Bell, Shield, ShieldAlert, Cpu, Sparkles, LogOut, Settings2, Power, AlertTriangle } from 'lucide-react';
...
export default function Topbar({ onSearch, systemAlertsCount, triggerSystemSimulate }: TopbarProps) {
